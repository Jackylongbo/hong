...
- (void)viewDidLoad {
    ...
    ForgetPass.font = [UIFont systemFontOfSize:12.0f];
    ForgetPass.titleLabel.textColor=[UIColor redColor];
    ForgetPass.alpha=0.2;
    ForgetPass.backgroundColor = [UIColor grayColor];
    ...
    freeRegister.backgroundColor =[UIColor grayColor];
...
-(void)loginBtn_clicked:(UIButton*)sender
{
    ...
    else if([nameField.text length]<9&&[passField.text length]<=16)
    {
