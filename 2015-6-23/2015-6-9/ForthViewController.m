...
- (void)viewDidLoad
{
    ...
    //
    scrollVoew=[[UIScrollView alloc] initWithFrame:CGRectMake(0, 60, self.view.bounds.size.width, self.view.bounds.size.height)];
    ...
    if (segmentControl.selectedSegmentIndex==0) {
        z_moneyimageView=[[UIView alloc] initWithFrame:CGRectMake(0, 40, scrollVoew.bounds.size.width, scrollVoew.bounds.size.height-40)];
        ...
        brief_label =[[UITextView alloc] initWithFrame:CGRectMake(0, money_image.bounds.size.height, self.view.bounds.size.width, scrollVoew.bounds.size.height-money_image.bounds.size.height)];
        ...
        brief_label.textAlignment=NSTextAlignmentJustified;
        brief_label.editable=NO;
        brief_label.font=[UIFont systemFontOfSize:15.0f];
...
-(void)change:(UISegmentedControl *)segmentcontrol
{
    ...
    if (segmentcontrol.selectedSegmentIndex==0) {
        ...
        [appoint_view removeFromSuperview];
        z_moneyimageView=[[UIView alloc] initWithFrame:CGRectMake(0, 40, scrollVoew.bounds.size.width, scrollVoew.bounds.size.height-40)];
    ...
    else if (segmentcontrol.selectedSegmentIndex==1)//选中流程
    {
        ...
        [appoint_view removeFromSuperview];
        process_imageview=[[UIImageView alloc] initWithFrame:CGRectMake(0, 40, scrollVoew.bounds.size.width, scrollVoew.bounds.size.height-60)];
    ...
    else if (segmentcontrol.selectedSegmentIndex==2)//选中预约
    {
        [z_moneyimageView removeFromSuperview];
        [process_imageview removeFromSuperview];
        appoint_view =[[UIView alloc] initWithFrame:CGRectMake(0, 40, self.view.bounds.size.width, scrollVoew.bounds.size.height)];
        appoint_phone=[[UILabel alloc] initWithFrame:CGRectMake(10, 5, scrollVoew.bounds.size.width-20, scrollVoew.bounds.size.height/14)];
        ...
        //
        appoint_remind=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height/14+5, scrollVoew.bounds.size.width-20, scrollVoew.bounds.size.height/14)];
        ...
        [appoint_view addSubview:appoint_remind];
        [appoint_view addSubview:appoint_phone];
        /*=========================日期=========================*/
        UILabel *_date=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height/7+10, 80, scrollVoew.bounds.size.height/14)];
        _date.text=@"预约日期:";
        date_field=[[UITextField alloc ] initWithFrame:CGRectMake(85, scrollVoew.bounds.size.height/7+10, scrollVoew.bounds.size.width-100, scrollVoew.bounds.size.height/14)];
        ...
        [appoint_view addSubview: _date];
        [appoint_view addSubview:date_field];
        
        /*=========================姓名=========================*/
        name_field=[[UITextField alloc] initWithFrame:CGRectMake(85, scrollVoew.bounds.size.height*3/14+15, scrollVoew.bounds.size.width-100, scrollVoew.bounds.size.height/14)];
        UILabel *_name=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height*3/14+15, 80, scrollVoew.bounds.size.height/14)];
        _name.text=@"您的姓名:";
        name_field.placeholder=@"必填";
        name_field.borderStyle=UITextBorderStyleRoundedRect;
        [appoint_view addSubview: _name];
        [appoint_view addSubview:name_field];
        
        /*=========================号码=========================*/
        UILabel *_phone=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height*4/14+25, 80, scrollVoew.bounds.size.height/14)];
        _phone.text=@"手机号码:";
        phone_field=[[UITextField alloc] initWithFrame:CGRectMake(85, scrollVoew.bounds.size.height*4/14+25, scrollVoew.bounds.size.width-100, scrollVoew.bounds.size.height/14)];
        phone_field.placeholder=@"必填";
        phone_field.borderStyle=UITextBorderStyleRoundedRect;
        [appoint_view addSubview:_phone];
        [appoint_view addSubview:phone_field];
        /*=========================人数=========================*/
        UILabel *_people=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height*5/14+35, 80, scrollVoew.bounds.size.height/14)];
        _people.text=@"人     数:";
        _people.textAlignment=NSTextAlignmentCenter;
        peple_field=[[UITextField alloc] initWithFrame:CGRectMake(85, scrollVoew.bounds.size.height*5/14+35, scrollVoew.bounds.size.width-100, scrollVoew.bounds.size.height/14)];
        peple_field.placeholder=@"选填";
        peple_field.borderStyle=UITextBorderStyleRoundedRect;
        [appoint_view addSubview:peple_field];
        [appoint_view addSubview:_people];
        
        /*=========================其他描述=========================*/
        UILabel* _otherDes=[[UILabel alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height*6/14+45, 80, scrollVoew.bounds.size.height/14)];
        _otherDes.text=@"其他描述:";
        other_field=[[UITextView alloc] initWithFrame:CGRectMake(85, scrollVoew.bounds.size.height*6/14+45, scrollVoew.bounds.size.width-100, scrollVoew.bounds.size.height/14+100)];
        //other_field.borderStyle=UITextBorderStyleRoundedRect;
        [appoint_view addSubview:_otherDes];
        [appoint_view addSubview:other_field];
        
        /*=========================提交=========================*/
        submit_button=[[UIButton alloc] initWithFrame:CGRectMake(10, scrollVoew.bounds.size.height-120, scrollVoew.bounds.size.width-20, scrollVoew.bounds.size.height/14)];
        ...
        [appoint_view addSubview:submit_button];
        [scrollVoew addSubview:appoint_view];
    }
}
#pragma mark - 手势
-(void)dismissKeyboard
