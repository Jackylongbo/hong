...
@property (strong,nonatomic)UIView *z_moneyimageView;
@property (strong,nonatomic)UITextView *brief_label;//简介
...
@property (strong,nonatomic)UIView *appoint_view;//预约页面
