#! /usr/bin/perl -w
#
# review.sh <svn-tool> <options> <default-tab> <ctx-lines> <show-func> <char-diffs> <dest-html> <paths...>
#
...
my ($svn, $options, $default_tab, $ctx_lines, $show_func, $char_diffs, $dest_html)
...
if ($char_diffs ne 0) { print("var CHAR_DIFFS = $char_diffs;\n"); system('cat', "$0/Review.js"); }
